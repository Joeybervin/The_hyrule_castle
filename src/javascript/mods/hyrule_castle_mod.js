...
function startModsGame(level = 10, gameMode) {
    let playerData = gameData_1.CharacterData.player;
    if (gameMode === 'dynamic') {
        playerData = (0, game_lib_1.getRandomCharacterFromFile)('/home/bervin_j/The_hyrule_castle/resources/players.json');
    }
    ...
    for (let floor = 1; floor <= level; floor++) {
        if (floor < level) {
            ...
            if (gameMode === 'dynamic') {
                enemyData = (0, game_lib_1.getRandomCharacterFromFile)('/home/bervin_j/The_hyrule_castle/resources/enemies.json');
            }
            ...
            if (gameMode === 'Dynamic') {
                bossData = (0, game_lib_1.getRandomCharacterFromFile)('/home/bervin_j/The_hyrule_castle/resources/bosses.json');
            }
