import { startBaseGame } from './base_game/hyrule_castle';
import { breakLine, displayGameName, displayMenu } from './lib/display.lib';
import { enterModGame } from './mods/easy/basic_game_customization';
